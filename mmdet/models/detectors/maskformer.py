...
class MaskFormer(SingleStageDetector):
    ...
    def onnx_export(self, img, img_metas, **kwargs):
        imgs = img
        batch_size,_,input_img_h, input_img_w = imgs.shape
        kwargs['batch_size'] = batch_size
        kwargs['input_img_h'] = input_img_h
        kwargs['input_img_w'] = input_img_w
        feats = self.extract_feat(imgs)
        mask_cls_results, mask_pred_results = self.panoptic_head.onnx_export( feats, img_metas, **kwargs)
